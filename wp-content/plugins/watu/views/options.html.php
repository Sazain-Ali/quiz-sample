...
<?php printf(__('This defaults to your main admin email. However to set a friendlier sender name you can overwrite it here by entering your name in format: <b>Your Name &lt;email@domain.com&gt;</b><br>If you have problems with getting your emails delivered, please install a plugin like <a href="%s" target="_blank">Postman SMTP</a>. Watu will send the emails through the SMTP server that you congigure in it.', 'watu'), '');?></p>	
...
<?php wp_nonce_field('watu_options'); ?>
	...
	<div class="wrap">
		<div class="postbox">
			<div class="inside">
				<h2><?php printf(__('Ajax in %s', 'watu'), WATU_QUIZ_WORD); ?></h2>
